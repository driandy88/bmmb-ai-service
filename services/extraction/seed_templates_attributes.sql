...
2. Advances Due to Director  |  Type: Numeric (multiple occurrences expected) — e.g. 50000
...
3. Net Worth or Total Equity  |  Type: Numeric (multiple occurrences expected) — e.g. 1060425
   Total shareholders'' equity from the Statement of Financial Position, labelled ''Total Equity'', ''Shareholders'' Funds'', or ''Net Worth''. Equals share capital plus retained earnings and reserves. If the statement shows an explicit ''Net Worth'' line separate from Total Equity, extract the Net Worth figure. May be negative where accumulated losses exceed share capital (capital deficiency). Financial statements present two or three comparative year columns side by side; extract one value per year column and keep it aligned with the corresponding Financial Statement Date. Figures in parentheses are negative. If the statement is presented in thousands (RM''000), multiply by 1,000 before storing.
4. Revenue or Turnover or Sales  |  Type: Numeric (multiple occurrences expected) — e.g. 4820500
...
5. Costs or COGS  |  Type: Numeric (multiple occurrences expected) — e.g. 3200000
...
6. Gross Profit  |  Type: Numeric (multiple occurrences expected) — e.g. 1620500
...
7. Expenses or Opex or SG&A or Overheads  |  Type: Numeric (multiple occurrences expected) — e.g. 816700
   Total operating expenses below the gross profit line, labelled ''Operating Expenses'', ''Administrative Expenses'', ''Selling and Distribution Expenses'', ''SG&A'', or ''Overheads''. Where several such lines are shown separately, sum them into a single value. Do NOT include Cost of Sales, Finance Costs, or Tax Expense. Store as a positive number even though it is presented as a deduction. Financial statements present two or three comparative year columns side by side; extract one value per year column and keep it aligned with the corresponding Financial Statement Date. Figures in parentheses are negative. If the statement is presented in thousands (RM''000), multiply by 1,000 before storing.
8. Operating Profit or EBIT  |  Type: Numeric (multiple occurrences expected) — e.g. 803800
...
9. EBITDA  |  Type: Numeric (multiple occurrences expected) — e.g. 905300
   Earnings before interest, tax, depreciation and amortisation. Extract only where the statement explicitly presents an ''EBITDA'' line, which is uncommon in Malaysian statutory accounts. Do not derive it by adding back Depreciation & Amortisation to EBIT — leave blank if not explicitly stated, and let the downstream model compute it from the component fields. Financial statements present two or three comparative year columns side by side; extract one value per year column and keep it aligned with the corresponding Financial Statement Date. Figures in parentheses are negative. If the statement is presented in thousands (RM''000), multiply by 1,000 before storing.
10. Financing Cost  |  Type: Numeric (multiple occurrences expected) — e.g. 197100
...
11. Depreciation & Amortisation  |  Type: Numeric (multiple occurrences expected) — e.g. 101500
...
12. Other Income  |  Type: Numeric (multiple occurrences expected) — e.g. 0
   Income from sources other than the principal revenue stream, labelled ''Other Income'', ''Other Operating Income'', or ''Sundry Income''. Includes interest income, rental income, and gains on disposal of assets. Presented as an addition; store as a positive number. Do not net it against expenses. Financial statements present two or three comparative year columns side by side; extract one value per year column and keep it aligned with the corresponding Financial Statement Date. Figures in parentheses are negative. If the statement is presented in thousands (RM''000), multiply by 1,000 before storing.
13. Profit Before Tax  |  Type: Numeric (multiple occurrences expected) — e.g. 606700
   Profit before taxation from the Statement of Profit or Loss, labelled ''Profit Before Tax'', ''PBT'', or ''Profit Before Taxation''. For Islamic-compliant entities it may read ''Profit Before Zakat and Tax'' — extract that figure. Equals Operating Profit minus Finance Costs. Negative if a loss before tax is reported. Financial statements present two or three comparative year columns side by side; extract one value per year column and keep it aligned with the corresponding Financial Statement Date. Figures in parentheses are negative. If the statement is presented in thousands (RM''000), multiply by 1,000 before storing.
14. Net Profit  |  Type: Numeric (multiple occurrences expected) — e.g. 461092
...
15. Asset Value or Total Current Assets  |  Type: Numeric (multiple occurrences expected) — e.g. 2466400
...
16. Liability Value  |  Type: Numeric (multiple occurrences expected) — e.g. 1405975
...
17. Balance Sheet Present  |  Type: Boolean — e.g. TRUE
...
18. Profit and Loss Statement Present  |  Type: Boolean — e.g. TRUE
...
19. Cash Flow Statement Present  |  Type: Boolean — e.g. FALSE
...
20. Auditor''s Report Present  |  Type: Boolean — e.g. TRUE
...
1. Bank Statement Month  |  Type: Alphanumeric (multiple occurrences expected) — e.g. July 2023
   The calendar month and year covered by one monthly statement, taken from the statement period header or the monthly summary block. Normalise to an English month name plus a four-digit year regardless of the source language. Malay month mapping: Januari=January, Februari=February, Mac=March, April=April, Mei=May, Jun=June, Julai=July, Ogos=August, September=September, Oktober=October, November=November, Disember=December. Extract the month and year only, not the full date range. A six-month bundle yields six values; this field keys the other three bank attributes.
2. Monthly Withdrawal  |  Type: Numeric (multiple occurrences expected) — e.g. 340980
   Total debits (withdrawals, payments, outflows) for the calendar month, taken from the monthly summary table and labelled ''Jumlah Debit / Total Debits'' (Maybank) or ''Total Debit'' (CIMB, RHB, Public Bank). This is the bank''s own aggregate figure — do not sum the individual transaction rows, which risks double counting reversals. Store as a positive number in RM, aligned to the Bank Statement Month of the same statement.
3. Monthly Deposit  |  Type: Numeric (multiple occurrences expected) — e.g. 362700
   Total credits (deposits, receipts, inflows) for the calendar month, taken from the monthly summary table and labelled ''Jumlah Kredit / Total Credits'' (Maybank) or ''Total Credit'' (CIMB, RHB, Public Bank). Use the bank''s aggregate figure, not the sum of transaction rows. Store as a positive number in RM, aligned to the Bank Statement Month of the same statement.
4. Monthly End Balance  |  Type: Numeric (multiple occurrences expected) — e.g. 266750
   The account balance on the last day of the calendar month, labelled ''Baki Akhir / Closing Balance'', ''Closing Balance'', or ''Balance c/f''. Should equal the opening balance of the following month, which is a useful continuity check across a six-month bundle. Negative if the account is overdrawn. Expressed in RM and aligned to the Bank Statement Month of the same statement.
...
INSERT INTO template_attributes (id, template_id, attribute_id, frequency, row_group) VALUES (185, 7, 15, 'multiple', NULL);
INSERT INTO template_attributes (id, template_id, attribute_id, frequency, row_group) VALUES (186, 7, 16, 'multiple', NULL);
INSERT INTO template_attributes (id, template_id, attribute_id, frequency, row_group) VALUES (187, 7, 17, 'multiple', NULL);
INSERT INTO template_attributes (id, template_id, attribute_id, frequency, row_group) VALUES (188, 7, 18, 'multiple', NULL);
INSERT INTO template_attributes (id, template_id, attribute_id, frequency, row_group) VALUES (189, 7, 19, 'multiple', NULL);
INSERT INTO template_attributes (id, template_id, attribute_id, frequency, row_group) VALUES (190, 7, 20, 'multiple', NULL);
INSERT INTO template_attributes (id, template_id, attribute_id, frequency, row_group) VALUES (191, 7, 21, 'multiple', NULL);
INSERT INTO template_attributes (id, template_id, attribute_id, frequency, row_group) VALUES (192, 7, 22, 'multiple', NULL);
INSERT INTO template_attributes (id, template_id, attribute_id, frequency, row_group) VALUES (193, 7, 23, 'multiple', NULL);
INSERT INTO template_attributes (id, template_id, attribute_id, frequency, row_group) VALUES (194, 7, 24, 'multiple', NULL);
INSERT INTO template_attributes (id, template_id, attribute_id, frequency, row_group) VALUES (195, 7, 25, 'multiple', NULL);
INSERT INTO template_attributes (id, template_id, attribute_id, frequency, row_group) VALUES (196, 7, 26, 'multiple', NULL);
INSERT INTO template_attributes (id, template_id, attribute_id, frequency, row_group) VALUES (197, 7, 27, 'multiple', NULL);
INSERT INTO template_attributes (id, template_id, attribute_id, frequency, row_group) VALUES (198, 7, 28, 'multiple', NULL);
INSERT INTO template_attributes (id, template_id, attribute_id, frequency, row_group) VALUES (199, 7, 29, 'multiple', NULL);
INSERT INTO template_attributes (id, template_id, attribute_id, frequency, row_group) VALUES (200, 7, 30, 'multiple', NULL);
